...
def gradient_descent(X, y, theta, alpha, num_iters):
    ...
    for i in range(num_iters):
        ...
        theta = theta - alpha * gradient   # atualização de θ

        # Armazena o custo da iteração atual para análise
        J_history[i] = compute_cost(X, y, theta)      # custo na iteração
        ...
        theta_history[i + 1] =  theta                  # armazena parâmetros atualizados
